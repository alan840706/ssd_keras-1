...
def SSD300(input_shape, num_classes=21):
    ...
    # Block 5
    net['conv5_1'] = Convolution2D(512, 3, 
                                   activation='relu',
                                   padding='same',
                                   name='conv5_1')(net['pool4'])
    net['conv5_2'] = Convolution2D(512, 3, 
                                   activation='relu',
                                   padding='same',
                                   name='conv5_2')(net['conv5_1'])
    net['conv5_3'] = Convolution2D(512, 3, 
                                   activation='relu',
                                   padding='same',
    ...
    # FC7
    net['fc7'] = Convolution2D(1024, 1,  activation='relu',
    ...
    # Block 7
    net['conv7_1'] = Convolution2D(128, 1,  activation='relu',
                                   padding='same',
    ...
    num_priors = 3
    x = Convolution2D(num_priors * 4, 3,  padding='same',
    ...
    x = Convolution2D(num_priors * num_classes, 3,  padding='same',
    ...
    # Prediction from fc7
    num_priors = 6
    net['fc7_mbox_loc'] = Convolution2D(num_priors * 4, 3, 
                                        padding='same',
    ...
    if num_classes != 21:
        name += '_{}'.format(num_classes)
    net['fc7_mbox_conf'] = Convolution2D(num_priors * num_classes, 3, 
                                         padding='same',
                                         name=name)(net['fc7'])
